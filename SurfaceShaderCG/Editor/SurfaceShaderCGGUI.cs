...
{
	public class SurfaceShaderCGGUI : ShaderGUI
	{
		...
		protected static class Styles
		{
			...
			public static string renderLayer = "Render Layer";
			public static string advancedText = "Advanced Options";
			public static readonly string[] blendNames = Enum.GetNames(typeof(BlendMode));
			public static readonly string[] cullNames = Enum.GetNames(typeof(Culling));
		}

		protected MaterialProperty blendMode = null;
		protected MaterialProperty culling = null;
		protected MaterialProperty layer = null;
		...
		protected virtual void SecondaryShaderProperties(Material material)
		{
		...
		protected virtual void ThirdShaderProperties(Material material)
		{
		...
		public void ShaderPropertiesGUI(Material material)
		{
			...
			EditorGUI.BeginChangeCheck();
			{
				BlendModePopup();
				CullingPopup();
				CustomRenderLayerPopup(material);

				// Primary properties
				PrimaryShaderProperties(material);

				EditorGUILayout.Space();

				// Secondary properties
				SecondaryShaderProperties(material);

				// Third properties
				ThirdShaderProperties(material);
			}
			if (EditorGUI.EndChangeCheck())
			{
		...
		void CustomRenderLayerPopup(Material material)
		{
			int renderlayer = Mathf.RoundToInt(layer.floatValue);
			EditorGUI.showMixedValue = layer.hasMixedValue;

			EditorGUI.BeginChangeCheck();
			renderlayer = EditorGUILayout.IntField(Styles.renderLayer, renderlayer);
			if (EditorGUI.EndChangeCheck())
			{
				m_MaterialEditor.RegisterPropertyChangeUndo("Render Layer");
				layer.floatValue = renderlayer;
				SetupMaterialWithBlendMode(material, (BlendMode)material.GetFloat("_Mode"));
			}
		...
		{
			int layer = Mathf.RoundToInt(material.GetFloat("_Layer"));
			...
			switch (blendMode)
			{
				...
				case BlendMode.Cutout:
					...
					material.DisableKeyword("_ALPHABLEND_ON");
					material.DisableKeyword("_ALPHAPREMULTIPLY_ON");
					material.renderQueue = (int)UnityEngine.Rendering.RenderQueue.AlphaTest + layer;
					break;
				case BlendMode.Fade:
					...
					material.DisableKeyword("_ALPHAPREMULTIPLY_ON");
					material.renderQueue = (int)UnityEngine.Rendering.RenderQueue.Transparent + layer;
					break;
